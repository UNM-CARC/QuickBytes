...
If you are on Windows, you can start with using PowerShell, but it is recommended to install MobaXterm for a better overall experience.
...
Where `CARC-USERNAME` is the username you were assigned once your account was approved. `MACHINE-NAME` will be one of our carc systems, such as `easley` or `wheeler`. If this is your first time logging in, you will get a prompt asking you to accept your computer as a new authorized host. You can accept this first prompt, then you will be prompted for your password. 
